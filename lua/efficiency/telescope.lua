...
vim.keymap.set("n", "<leader>fde", require("telescope").extensions.dap.commands, { desc = "Debug" })
vim.keymap.set( "n", "<leader>fdc", require("telescope").extensions.dap.configurations, { desc = "Debug configurations" })
vim.keymap.set("n", "<leader>fdb", require("telescope").extensions.dap.list_breakpoints, { desc = "Debug breakpoints" })
vim.keymap.set("n", "<leader>fdv", require("telescope").extensions.dap.variables, { desc = "Debug variables" })
vim.keymap.set("n", "<leader>fdf", require("telescope").extensions.dap.frames, { desc = "Debug frames" })
