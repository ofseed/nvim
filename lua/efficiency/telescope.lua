...
vim.keymap.set("n", "<leader>f?", require("telescope.builtin").help_tags)
vim.keymap.set("n", "<leader>fh", require("telescope.builtin").oldfiles)
vim.keymap.set("n", "<leader>fb", require("telescope.builtin").marks)
...
vim.keymap.set("n", "<leader>fde", require("telescope").extensions.dap.commands)
vim.keymap.set("n", "<leader>fdc", require("telescope").extensions.dap.configurations)
